...
public class ModAPIImpl extends WFTApi {
	...
	public void openWFTGui(final EntityPlayer player, final boolean isBauble, final int wftSlot) {
		...
		final ItemStack is = isBauble ? WTApi.instance().getBaublesUtility().getWTBySlot(player, wftSlot, IWirelessFluidTerminalItem.class) : WFTUtils.getWFTBySlot(player, wftSlot);
